...
public class LogoApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(LogoApp.class);

    private final Environment env;

    public LogoApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LogoApp.class);
